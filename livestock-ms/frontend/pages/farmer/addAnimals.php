    ...
    <div class="full-screen">
      <div class="left-wing">
        ...
        <nav class="side-bar">
          <ul>
            ...
            <li><a href="addAnimals.php" class="side-link active-link">Add Animals</a></li>
      ...
      <div class="right-side">
        ...
        <div class="form-container">
          <form class="form-card" action="../../../backend/add_animal_process.php" method="POST">
            <h2>Add new animal</h2>

            <div class="form-grid">
              <div class="form-group">
                <label>Animal name / tag</label>
                <input type="text" name="animal_name" placeholder="e.g. Bessie #001">
              </div>

              <div class="form-group">
                <label>Category</label>
                <input type="text" name="category" placeholder="e.g. Cattle">
              </div>
